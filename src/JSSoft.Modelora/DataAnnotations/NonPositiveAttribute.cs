// <copyright file="NonPositiveAttribute.cs" company="JSSoft">
...
public sealed class NonPositiveAttribute : SignComparisonAttribute
{
    ...
    protected override string FormatErrorMessage(
        ...
        => $"The property {memberName} of {declaringType.Name} must be less than or equal to zero. " +
           $"Current value: {value}.";
}
