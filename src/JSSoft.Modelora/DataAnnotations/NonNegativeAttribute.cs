// <copyright file="NonNegativeAttribute.cs" company="JSSoft">
...
public sealed class NonNegativeAttribute : SignComparisonAttribute
{
    ...
    protected override string FormatErrorMessage(
        ...
        => $"The property {memberName} of {declaringType.Name} must be greater than or equal to zero. " +
           $"Current value: {value}.";
}
